...
const Square = ({ gameState, setGameState,socket,playingAs,currentElement, id, currentPlayer,finishedState,finishedArrayState,setFinishedState, setCurrentPlayer }) => {
